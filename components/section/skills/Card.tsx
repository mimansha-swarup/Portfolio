...
const Card = ({ title, index }: ICardProps) => {
  ...
  return (
    <motion.div
      ...
      className="w-full flex items-end max-w-[188px] h-[146px] overflow-hidden hover:overflow-visible p-4 rounded border-[1px] border-primary-200 relative group bg-dark-500"
    >
